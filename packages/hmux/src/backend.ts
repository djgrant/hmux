/**
 * The backend seam. hmux itself is the advertise protocol + dashboard; a
...
/** A terminal parked by `hmux target`, identified by its tty. */
...
export interface Backend {
   ...
   * every hmux entrypoint. For tmux this is where a dead server after a reboot
  ...
  /**
   * Live display targets: terminals that ran `hmux target` and are still
