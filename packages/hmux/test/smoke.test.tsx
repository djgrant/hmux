  ...
  setGroups([
    {
      ...
      windows: [
        { target: "api:1", session: "api", name: "claude", dir: "~/Repos/api", agent: "api-3f2c · sonnet", active: true, paneCount: 2, paneId: "%0", transcript: null, status: "message", detail: "approve the plan?", panes: [] },
        { target: "api:2", session: "api", name: "server", dir: "~/Repos/api", agent: null, active: false, paneCount: 1, paneId: "%0", transcript: null, status: "busy", detail: null, panes: [] },
      ],
    },
    {
      target: "web",
      ...
      status: null,
      detail: null,
      windows: [{ target: "web:1", session: "web", name: "zsh", dir: "~/Repos/web", agent: null, active: true, paneCount: 1, paneId: "%0", transcript: null, status: null, detail: null, panes: [] }],
    },
  ])
  updateQuery("")
  setSelected(0)
...
test("parked cursor follows the attached session's active window", async () => {
  const w = (target: string, name: string, active: boolean) => ({
    target, session: "api", name, dir: "~/Repos/api", agent: null, active, paneCount: 1, paneId: "%0", transcript: null, status: null, detail: null, panes: [],
  })
...
test("left/right jump to sessions with an advertised agent, skipping bare shells", async () => {
  ...
  setGroups([
    { target: "web", name: "web", dir: "~", attached: false, status: "busy", detail: null,
      windows: [{ target: "web:1", session: "web", name: "claude", dir: "~", agent: null, active: true, paneCount: 1, paneId: "%0", transcript: null, status: "busy", detail: null, panes: [] }] },
    { target: "shell", name: "shell", dir: "~", attached: false, status: null, detail: null,
      windows: [{ target: "shell:1", session: "shell", name: "zsh", dir: "~", agent: null, active: true, paneCount: 1, paneId: "%0", transcript: null, status: null, detail: null, panes: [] }] },
    { target: "ops", name: "ops", dir: "~", attached: false, status: "error", detail: null,
      windows: [{ target: "ops:1", session: "ops", name: "zsh", dir: "~", agent: null, active: true, paneCount: 1, paneId: "%0", transcript: null, status: "error", detail: null, panes: [] }] },
  ])
  updateQuery("")
  setSelected(0)
