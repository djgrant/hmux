...
export function App(props: {
  ...
  // highlighted/current message, truncated); neutral "hmux" when empty.
  ...
  createEffect(() => {
    ...
    renderer.setTerminalTitle(firstLine.length > 0 ? firstLine.slice(0, 60) : "hmux")
  })
  ...
  createEffect(() => {
    ...
    // "iTerm") is worse than one. HMUX_MAILBOX_NOTIFY=1 overrides.
    if (process.env.HMUX_MAILBOX_NOTIFY !== "1" && menuAppRunning()) return
