...
const messages: Message[] = [
  { id: "m1", kind: "ask", agent: "refactor-bot", project: "humans.sh", body: "Rename `Queue` to **Inbox**?", status: "pending", createdAt: now - 2 * 60_000 },
  { id: "m2", kind: "ask", agent: "deploy-bot", project: "humans.sh", body: "Ship now?", context: "CI is green.", suggestion: "yes, ship it", status: "pending", createdAt: now - 60 * 60_000 },
  { id: "m3", kind: "ask", agent: "scraper", body: "Back off 1h?", status: "pending", createdAt: now - 5 * 60_000 },
  { id: "m4", kind: "ask", agent: "docs-bot", project: "humans.sh", body: "Bold headings?", status: "answered", answer: "Yes.", createdAt: now - 3 * 3_600_000, answeredAt: now - 2 * 3_600_000 },
...
test("merge-select, notify dismiss, pruned focus keys, hints", async () => {
  ...
  // pending order: humans.sh [m2, m1], (no project) [m3, m6-notify]
  ...
  expect(notified).toEqual([["ping-bot: line one", "humans.sh"]])
  ...
  await settle()
  expect(notified.at(-1)).toEqual(["ping-bot: third", "humans.sh"])
